...
let settingsDialogIsOpen = $state(false);
 ...
 const handleKeyDown = (e: KeyboardEvent) => {
    ...
    const ctrlOrCommandKeyIsDown = (e.metaKey && isMac) || (e.ctrlKey && (OS === "Windows" || OS === "Other"));
    
    const isSaveAsCommand = e.key.toLowerCase()=== "s" && e.shiftKey && ctrlOrCommandKeyIsDown;
    const isSaveCommand = e.key.toLowerCase()=== "s" &&  ctrlOrCommandKeyIsDown;
    const isCreateCommand = e.key.toLowerCase() === "c" && ctrlOrCommandKeyIsDown;
...
<sl-dropdown>
  ...
  O</span>
    ...
    <sl-menu-item value="save">Save  <span class="command" slot="suffix">
      {#if isMac} 
        <sl-icon library="pixelarticons" name={"command"}></sl-icon> 
        ...
        {/if}
  S </span> </sl-menu-item>
    <sl-menu-item value="save-as">Save As <span class="command" slot="suffix">
         {#if isMac} 
        <sl-icon library="pixelarticons" name={"command"}></sl-icon> 
  ...
  S</span>
    ...
    <sl-menu-item value="settings">Settings <sl-icon slot="suffix" name="gear"></sl-icon></sl-menu-item>
